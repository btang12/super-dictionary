...
/**
 * Junit test class to test class @see Graph that implements @see GraphADT
 * interface
 *
...
public class GraphTest {
	...
	public final void removeVertexReturnsNonNull() {
		...
		assertEquals("return value if vertex passed to removeVertex is connected to another vertex", vertices.get(0),
				vertex);
		...
		for (String itrVertex : this.graph.getAllVertices()) {
			...
			for (String itrNeighbor : this.graph.getNeighbors(itrVertex)) {
				numOfEdges++;
				assertEquals(String.format("presence of neighbor=%s of vertex=%s", itrNeighbor, itrVertex), false,
						itrVertex.equals(vertices.get(0)) && itrNeighbor.equals(vertices.get(1)));
				assertEquals(String.format("presence of neighbor=%s of vertex=%s", itrNeighbor, itrVertex), false,
						itrVertex.equals(vertices.get(1)) && itrNeighbor.equals(vertices.get(0)));
			}
